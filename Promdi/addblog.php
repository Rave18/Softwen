...
$query=$conn->prepare("insert into tblBlogs values(null,:BlogTitle,:BlogDate,:BlogBody)");
$query->bindParam("BlogTitle",$blogtitle);
$query->bindParam("BlogDate",$blogdate);	
$query->bindParam("BlogBody",$blogbody);
$query->execute();
$error="You successfully added a blog";
}
...
<div id="wrapper">
	...
	<li><a href="addblog.php" class="under"><strong>WRITE A BLOG</strong></a></li>
		...
		<h3 style="font-family:Cambria;text-align:center"><a href="viewblogs.php">View Blogs</a>      |<a href="addblog.php">Add Blog</a>      |     <a href="updateblog.php">Update Blog</a></h3>
	<h3 style="font-family:Cambria;text-align:center">ADD BLOG</h3></br>
...
<fieldset>
<input type="text" name="BlogTitle" placeholder="Title" size="35" id="blogtitle" style="margin:5px:" required/><br>
<input type="date" name="BlogDate" id="date" size="35"  required/><br>
<textarea name="BlogBody" placeholder="Write your blog here" size="300" id="blogbody" style="margin:5px:"/ ></textarea>
<strong><input type="submit" id="addblog" value="Submit" name="addbutton"></strong>
</fieldset>
</form>
</article>
