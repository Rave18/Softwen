...
<div id="wrapper">
  ...
  <div id="line">
	   ...
	   <div id="content">
	   <h3>Error 404 </h3>
	 <div class='alert alert-danger' style ="margin-top:30px">You need to login to access this page! Click <a href="promdisignup.php">here</a> to create an account.</div>
    </div>
