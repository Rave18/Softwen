...
<div id="wrapper">
	...
	<div id="log">
		...
		<h3 style="font-family:Cambria;text-align:center"><a href="addproduct.php">Add Product</a>      |     <a href="">Update Product</a>     </h3>
	
	
<h3 style="font-family:Cambria;text-align:center">UPDATE PRODUCT</h3></br>
	 ...
	 <tr><th>Product ID</th><th>Product Name</th><th>Quantity</th><th>Price</th><th>Product Description</th></tr>
	 <?php
	 while($row=$query->fetch(PDO::FETCH_ASSOC)){
		 echo "<tr><td>".$row["ID"]."</td><td>".$row["ProductName"]."</td><td>".$row["Quantity"]."</td><td><a href='updateprice.php?id=".$row["ID"]."'> ".$row["Price"]."</td><td><a href='updateproddesc.php?id=".$row["ID"]."'> ".$row["ProdDesc"]."</td></tr>";
