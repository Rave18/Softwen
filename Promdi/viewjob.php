...
<div id="wrapper">
	...
	<div id="log">
		...
		<h3 style="font-family:Cambria;text-align:center"><a href="viewjob.php">View Jobs</a>      |<a href="addjob.php">Add Job</a>      |     <a href="updatejob.php">Update Job</a>     </h3>
	
	
	
		<h3 style="font-family:Cambria;text-align:center">VIEW JOBS</h3></br>
		<div id="content">
<?php
...
<div id='Post-Message'>
<p> $conte . . .</br><br/><a href='adminjobdesc.php?ID=".$row["ID"]."'>Read more</p></a>
</div>
</article>";
		}
?>
