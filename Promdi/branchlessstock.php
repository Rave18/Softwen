...
session_destroy();
	...
	if(isset($_POST["edit"])){
		$quantity=filter_input(INPUT_POST,"quant");
		$stocks=filter_input(INPUT_POST,"stocks");
...
<div id="wrapper">
	...
	load_prods();
		 ...
		 while($row=$query->fetch(PDO::FETCH_ASSOC)){
			 ...
			 <input type='hidden' value=".$row["Quantity"]." name='quant'>
			 ";
		...
		<label style="font-family:Cambria;font-size:18px"> Less Stock: </label><input type="number" min="1" max="99" name="stocks"  size="35" id="prod2" required/><br>
		<input type="submit" value="Less" name="edit" id="addstock">
	</form>
