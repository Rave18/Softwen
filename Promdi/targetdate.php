...
if(filter_input(INPUT_POST,"button1")){
		...
		$body="We have recieved your order. The product you ordered will be delivered on $Target. Thank you for ordering Promdi Lola, we hope to transact with you again soon!";
		$qry->execute();
		
		
				$error="The target date had been sent";
...
load_prods();
	...
	<label style="font-family:Cambria;font-size:18px">Target Date to be delivered:<input type="date" name="TargetDate" id="date" size="35"  required/><br>
