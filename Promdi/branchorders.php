...
<table class ="table table-striped">
 <tr><th>Branch Name</th><th>Payment Method</th><th>Status</th></th><th></th></tr>
<?php

		$query=$conn->prepare("select * from tblorders where accountid=:aid");
		$query->bindParam("aid",$_SESSION["ID"]);
		$query->execute();
	 while($row=$query->fetch(PDO::FETCH_ASSOC)){
		 echo "<tr><td>".$row["FirstName"]."</td><td>".$row["PaymentMethod"]." </td><td>".$row["Status"]."</td><td><a href='branchorderlist.php?id=".$row["ID"]."'>See my Orders </a></td></tr>";
