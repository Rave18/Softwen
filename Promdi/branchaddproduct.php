...
$quantity="0";
$query=$conn->prepare("insert into tblproducts values(null,:ProductName,:ProdDesc,:Quantity,:Price,:image,:branchid)");
$query->bindParam("ProductName",$prodname);
$query->bindParam("ProdDesc",$proddesc);
$query->bindParam("Quantity",$quantity);
$query->bindParam("Price",$price);
$query->bindParam("image",$image);
$query->bindParam("branchid",$_SESSION["ID"]);
$query->execute();
...
<input type="number" max="999" min="0" name="Price" placeholder="Price"  id="prod3" size="35" style="margin:5px:" required/><br>
