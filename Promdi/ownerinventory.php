...
<div id="wrapper">
	...
	<h3 style="font-family:Cambria;text-align:center">INVENTORY</h3></br>
	 ...
	 <tr><th>Product ID</th><th>Product Name</th><th>Quantity</th><th>Price</th><th></th></tr>
	 <?php
	 while($row=$query->fetch(PDO::FETCH_ASSOC)){
		 echo "<tr><td>".$row["ID"]."</td><td>".$row["ProductName"]."</td><td>".$row["Quantity"]."</td><td>".$row["Price"]."</td><td><a href='addstock?id=".$row["ID"]."'><button type='button' class='btn btn-info' id='okay'  data-toggle='modal' data-target='#myModal' style='float:left;'>ADD STOCK  </a></td></tr>";
