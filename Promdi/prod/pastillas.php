...
<strong><input type="submit" value="LOGIN"/></strong>
	...
	<div id="content">
    <div id="prodImage"><img src="images/pastillas.jpg" width="560" height="400"/></div>
	><div id="prodDes">
    	<h3><strong>PASTILLAS DE LECHE</strong></h3>
      <p>Sweet and chewy milk pastilles from Bulacan prepared by the traditional way using fresh Carabao's milk.</p>
...
<article>
    ...
    <section class="col">
    	<div class="imageContainer"><a href="banana.php"><img src="images/banana.jpg" width="200" height="200" alt=""/></a>
