...
<strong><input type="submit" value="LOGIN"/></strong>
	...
	<div id="content">
    <div id="prodImage"><img src="images/seadless sampaloc.jpg" width="560" height="400"/></div>
	><div id="prodDes">
    	<h3><strong>SEEDLESS SAMPALOC</strong></h3>
      <p>Sweet, sour, salty and chewy tamarind candies from a Laguna grandmother's heirloom recipe</p>
