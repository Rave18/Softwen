...
<div id="wrapper">
	...
	<h3 style="font-family:Cambria;text-align:center"><a href="notif.php">Inbox</a>      |     <a href="usersent.php">Sent</a>      </h3>
		<h3 style="font-family:Cambria;text-align:center">INBOX</h3></br>
		<div id="content">
<?php

			$query=$conn->prepare("select *, tblnotif.ID AS nid from tblnotif LEFT JOIN tblaccounts ON AccountID = tblaccounts.ID ORDER BY tblnotif.ID DESC");
...
<small>From ".$row["Username"]."</small>
</section>
<div id='Post-Message'>
<p> $conte <a href='adminnotifdesc.php?ID=".$row["nid"]."'>View Message</a> </br></br></br><br> <a href='writeadmin.php?ID=".$row["ID"]."'>Reply To Message</a></p>
