...
<div id="wrapper">
	...
	<h2 style="font-family:Cambria;text-align:center">Notifications</h2>
	<h3 style="font-family:Cambria;text-align:center"><a href="addproduct.php">Inbox</a>      |     <a href="updateprod.php">Sent</a>      </h3>
<?php

		$query=$conn->prepare("select * from tblnotif");
		$query->execute();
...
<section class='Post-Heading'>
		...
		<h3>".$row["Title"]."</h3>
<small>Recieved message on ".$row["Date"]."</small>
</section>
<div id='Post-Message'>
<p> $conte . . . &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp ".$row["Status"]."</br><br/>from ".$row["accountid"]."</p></a>
</div>
</article>";
		}
?>
