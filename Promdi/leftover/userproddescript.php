...
<p>Quantity:</p><input type='text' name='quantity' id='quantity' placeholder='1' size='15' required/>
...
?>
	 ...
	 <div class='imageContainer'><a href=".$row["ProductName"].">
			<a href='sample.php?id=".$row["ID"]."'><img src='data:image;base64,".$row["product_image"]."' width='200' height='200'></a>
