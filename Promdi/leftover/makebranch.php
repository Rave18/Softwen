...
<h3 style="font-family:Cambria;text-align:center">SETTINGS</h3>
		...
		<h3 style="font-family:Cambria;text-align:center"><a href="settings.php">Change My Password</a>|<a href="makeadmin.php">Create Admin</a>      |     <a href="makebranch.php">Create Branch</a></h3>

<article>
<form method="POST" id="form1">
<fieldset>
<h3 style="font-family:Cambria;text-align:center">CREATE BRANCH</h3></br>
