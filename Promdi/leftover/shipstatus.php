...
$qry->execute();
	...
	$shipstatus="Shipped";
		$query=$conn->prepare("update tblorders set ShippingStatus=:shipstatus where ID=:id");
...
<div id="wrapper">
	...
	<div id="welcome">
		<div id="welcomee">
			<h4 style="text-align:left;"><em>WELCOME, OWNER!</em></h4>
		</div>
			<div id="log">
...
load_prods();
	...
	<label style="font-family:Cambria;font-size:18px">Tracking Number:<input type="text" name="TransNum" id="date" size="35"  required/><br>
