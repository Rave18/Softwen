...
<div id="wrapper">
	...
	if(isset($_GET["edit"])){
		...
		$id=$_GET["id"];
		$stock=$_GET["Stock"];
		$query=$conn->prepare("update tblProducts set Stocks=$stock where ID=$id");
...
load_prods();
	...
	<label style="font-family:Cambria;font-size:18px">Product Description: </label><textarea rows="2" cols="25" name="ProdDesc" size="100" id="prod" style="margin:5px:"required/ ></textarea></br>
	<label style="font-family:Cambria;font-size:18px">Price:  </label><input type="number" min="1" max="99" name="Quantity"  size="35" id="prod2" ><br>
