...
?>
	...
	<h3 style="font-family:Cambria;text-align:center"><a href="writebranch.php">Write To Admin</a>      |<a href="branchnotif.php">Inbox</a>      |     <a href="branchsent.php">Sent</a>      </h3>
		<h2 style="font-family:Cambria;text-align:center">Sent</h2></br>
			<div id="content">
<?php

		$query=$conn->prepare("select * from tblnotif where AccountID=:aid ORDER BY tblnotif.ID DESC");
...
<div id='Post-Message'>
<p> $conte <a href='branchsentnotif.php?ID=".$row["ID"]."'><br>View Message</a> </br></br></br></p>
</div>
</article>";
		}
?>
