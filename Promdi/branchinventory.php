...
?>
	...
	$query->bindParam("id",$_SESSION["ID"]);
		...
		//print "select id,productname,quantity,price from tblproducts WHERE tblproducts.BranchID = {$_SESSION["ID"]}";//
	?>	
	 ...
	 while($row=$query->fetch(PDO::FETCH_ASSOC)){
		 echo "<tr><td>".$row["ID"]."</td><td>".$row["ProductName"]."</td><td>".$row["Quantity"]."</td><td>".$row["Price"]."</td><td><a href='branchaddstock?id=".$row["ID"]."'><button type='button' class='btn btn-info' id='okay'  data-toggle='modal' data-target='#myModal' style='float:left;'>ADD  </a> /<a href='branchlessstock?id=".$row["ID"]."'> LESS </a></button></td></tr>";
