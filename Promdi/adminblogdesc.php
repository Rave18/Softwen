...
?>
	...
	echo"
	<h1 id='Title'>".$row["BlogTitle"]."</h1>
	<p class='postinfo'>Posted on ".$row["BlogDate"]."</p>
	<p id='parag'>".$row["BlogBody"]."</p>
</article>
";
		}
	?>
...
while($row=$query->fetch(PDO::FETCH_ASSOC)){	
echo " 
      	<h3><strong>".$row["BlogTitle"]."</strong></h3>
		
		<p>".$row["BlogBody"]."</strong></p>
		";
}
?>
